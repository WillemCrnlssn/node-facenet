...
test('constructor()', (t) => __awaiter(this, void 0, void 0, function* () {
    const IMAGE_DATA_3_3 = fixtures_1.fixtureImageData3x3();
    const BOX_0_0_3_3 = [0, 0, 3, 3];
    const EXPECTED_RECT_0_0_3_3 = {
        x: 0, y: 0,
        w: 3, h: 3,
    };
    const EXPECTED_RECT_0_0_2_2 = {
        x: 0, y: 0,
        w: 2, h: 2,
    };
    ...
    t.test('with full bounding box', (t) => __awaiter(this, void 0, void 0, function* () {
        const face = new face_1.Face(IMAGE_DATA_3_3);
        yield face.init({ boundingBox: BOX_0_0_3_3 });
    ...
    t.test('with sub bounding box that needs corp', (t) => __awaiter(this, void 0, void 0, function* () {
        const BOX = [0, 0, 2, 2];
        const face = new face_1.Face(IMAGE_DATA_3_3);
        yield face.init({ boundingBox: BOX });
    ...
    t.test('via filename', (t) => __awaiter(this, void 0, void 0, function* () {
        ...
        const face = new face_1.Face();
        yield face.init({ file: IMAGE_RGB_BWT_FILE });
        t.deepEqual(face.imageData && face.imageData.data, EXPECTED_IMAGE_RGB_BWT_ARRAY, 'should load imageData with init file');
    }));
}));
test('JSON implementations', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    t.test('get embedding()', (t) => __awaiter(this, void 0, void 0, function* () {
        const face = new face_1.Face(IMAGE_DATA);
        yield face.init({ boundingBox: BOX });
    ...
    t.test('toJSON()', (t) => __awaiter(this, void 0, void 0, function* () {
        const face = new face_1.Face(IMAGE_DATA);
        yield face.init({
            boundingBox: BOX,
            landmarks: MARKS,
    ...
    t.test('fromSON()', (t) => __awaiter(this, void 0, void 0, function* () {
        const face = face_1.Face.fromJSON(JSON_TEXT);
        ...
        t.ok(face.embedding instanceof nj.NdArray, 'should get back a numjs NdArray');
...
test('squareBox()', (t) => __awaiter(this, void 0, void 0, function* () {
    t.pass('ok');
}));
//# sourceMappingURL=face.spec.js.map